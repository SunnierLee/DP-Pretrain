...
from .ddpoptimizer import DistributedDPOptimizer, CNDistributedDPOptimizer
from .optimizer import DPOptimizer, CNDPOptimizer
...
def get_optimizer_class(clipping: str, distributed: bool, grad_sample_mode: str = None):
    ...
    elif clipping == "correlated" and distributed is False:
        return CNDPOptimizer
    elif clipping == "correlated" and distributed is True:
        return CNDistributedDPOptimizer
